...
# This script returns geographic bounds rounded to the  that intersect the spatial extent extracted from geotransform information of an input image.  This code is sourced from https://gis.stackexchange.com/questions/57834/how-to-get-raster-corner-coordinates-using-python-gdal-bindings
